...
export default function ContactBar() {
  const { t } = useLanguage()
  return (
    <div className="cbar" role="complementary" aria-label={t('contactBar.aria')}>
      ...
      <a href={company.whatsapp} target="_blank" rel="noopener noreferrer" className="cbar__whatsapp">
        ...
        <span className="cbar__label">{t('contactBar.whatsapp')}</span>
      </a>
